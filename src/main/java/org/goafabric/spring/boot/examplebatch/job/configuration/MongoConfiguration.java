...
@EnableAutoConfiguration(exclude = {JdbcRepositoriesAutoConfiguration.class}) //we cannot disable DataSourceConfiguration because Spring Batch needs it for H2In Memory Repository
